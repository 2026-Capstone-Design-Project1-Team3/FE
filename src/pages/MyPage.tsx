    ...
    <main>
      <div className="p-8 py-10">
        ...
        <div className="flex flex-col gap-6 lg:flex-row">
          <section className="flex-4 overflow-hidden rounded-2xl border border-gray-300 bg-white">
            ...
            <div className="flex items-center justify-end gap-4 p-10">
              ...
              <button className="bg-primary-800 border-primary-800 hover:bg-primary-700 hover:border-primary-800/80 cursor-pointer rounded-xl border-2 px-7 py-2 text-white">
                정보 저장하기
              </button>
            </div>
          </section>
        ...
        <div className="flex gap-4 pt-5">
          <button className="flex cursor-pointer gap-1 rounded-xl border-2 border-gray-600 px-6 py-2 text-gray-600 hover:bg-gray-600 hover:text-white">
            <LogOut size={24} />
            로그아웃
          </button>
          <button className="border-error-01/80 text-error-01/80 hover:bg-error-01/80 flex cursor-pointer gap-1 rounded-xl border-2 px-6 py-2 hover:text-white">
            <UserMinus size={24} />
            회원 탈퇴
          </button>
        </div>
